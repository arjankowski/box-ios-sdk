...
public class AddClassificationRequestBodyDataStaticConfigClassificationField: Codable {
    ...
    /// Initializer for a AddClassificationRequestBodyDataStaticConfigClassificationField.
    ///
    /// - Parameters:
