...
public class CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigClassificationField: Codable {
    ...
    /// Initializer for a CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigClassificationField.
    ///
    /// - Parameters:
    ///   - classificationDefinition: A longer description of the classification.
    ///   - colorId: An identifier used to assign a color to
    ///     a classification label.
    ///
    ///     Mapping between a `colorID` and a color may
    ///     change without notice. Currently, the color
