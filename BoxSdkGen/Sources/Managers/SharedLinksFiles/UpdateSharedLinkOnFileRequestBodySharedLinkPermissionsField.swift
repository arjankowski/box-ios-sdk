...
public class UpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField: Codable {
    ...
    /// Initializer for a UpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField.
    ///
    /// - Parameters:
