...
public class IntegrationMappingsManager {
    ...
    public func getSlackIntegrationMapping(queryParams: GetSlackIntegrationMappingQueryParams = GetSlackIntegrationMappingQueryParams(), headers: GetSlackIntegrationMappingHeaders = GetSlackIntegrationMappingHeaders()) async throws -> IntegrationMappings {
        ...
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/integration_mappings/slack")", method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
    ...
    public func updateSlackIntegrationMappingById(integrationMappingId: String, requestBody: UpdateSlackIntegrationMappingByIdRequestBody = UpdateSlackIntegrationMappingByIdRequestBody(), headers: UpdateSlackIntegrationMappingByIdHeaders = UpdateSlackIntegrationMappingByIdHeaders()) async throws -> IntegrationMapping {
        let headersMap: [String: String] = Utils.Dictionary.prepareParams(map: Utils.Dictionary.merge([:], headers.extraHeaders))
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/integration_mappings/slack/")\(integrationMappingId)", method: "PUT", headers: headersMap, data: requestBody.serialize(), contentType: "application/json", responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
        return try IntegrationMapping.deserialize(from: response.data!)
    }
    ...
    public func deleteSlackIntegrationMappingById(integrationMappingId: String, headers: DeleteSlackIntegrationMappingByIdHeaders = DeleteSlackIntegrationMappingByIdHeaders()) async throws {
        let headersMap: [String: String] = Utils.Dictionary.prepareParams(map: Utils.Dictionary.merge([:], headers.extraHeaders))
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/integration_mappings/slack/")\(integrationMappingId)", method: "DELETE", headers: headersMap, responseFormat: ResponseFormat.noContent, auth: auth, networkSession: networkSession))
    }
    ...
    public func getTeamsIntegrationMapping(queryParams: GetTeamsIntegrationMappingQueryParams = GetTeamsIntegrationMappingQueryParams(), headers: GetTeamsIntegrationMappingHeaders = GetTeamsIntegrationMappingHeaders()) async throws -> IntegrationMappingsTeams {
        ...
        let headersMap: [String: String] = Utils.Dictionary.prepareParams(map: Utils.Dictionary.merge([:], headers.extraHeaders))
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/integration_mappings/teams")", method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
    ...
    public func createTeamsIntegrationMapping(requestBody: IntegrationMappingTeamsCreateRequest, headers: CreateTeamsIntegrationMappingHeaders = CreateTeamsIntegrationMappingHeaders()) async throws -> IntegrationMappingTeams {
        let headersMap: [String: String] = Utils.Dictionary.prepareParams(map: Utils.Dictionary.merge([:], headers.extraHeaders))
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/integration_mappings/teams")", method: "POST", headers: headersMap, data: requestBody.serialize(), contentType: "application/json", responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
    ...
    public func updateTeamsIntegrationMappingById(integrationMappingId: String, requestBody: UpdateTeamsIntegrationMappingByIdRequestBody = UpdateTeamsIntegrationMappingByIdRequestBody(), headers: UpdateTeamsIntegrationMappingByIdHeaders = UpdateTeamsIntegrationMappingByIdHeaders()) async throws -> IntegrationMappingTeams {
        let headersMap: [String: String] = Utils.Dictionary.prepareParams(map: Utils.Dictionary.merge([:], headers.extraHeaders))
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/integration_mappings/teams/")\(integrationMappingId)", method: "PUT", headers: headersMap, data: requestBody.serialize(), contentType: "application/json", responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
        return try IntegrationMappingTeams.deserialize(from: response.data!)
    }
    ...
    public func deleteTeamsIntegrationMappingById(integrationMappingId: String, headers: DeleteTeamsIntegrationMappingByIdHeaders = DeleteTeamsIntegrationMappingByIdHeaders()) async throws {
        let headersMap: [String: String] = Utils.Dictionary.prepareParams(map: Utils.Dictionary.merge([:], headers.extraHeaders))
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/integration_mappings/teams/")\(integrationMappingId)", method: "DELETE", headers: headersMap, responseFormat: ResponseFormat.noContent, auth: auth, networkSession: networkSession))
    }
}
