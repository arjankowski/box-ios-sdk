...
public class AddShareLinkToWebLinkRequestBodySharedLinkField: Codable {
    ...
    /// accounts.
    public let access: AddShareLinkToWebLinkRequestBodySharedLinkAccessField?
    ...
    public let permissions: AddShareLinkToWebLinkRequestBodySharedLinkPermissionsField?

    /// Initializer for a AddShareLinkToWebLinkRequestBodySharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     current date and time.
    ///   - permissions:
    public init(access: AddShareLinkToWebLinkRequestBodySharedLinkAccessField? = nil, password: TriStateField<String> = nil, vanityName: String? = nil, unsharedAt: Date? = nil, permissions: AddShareLinkToWebLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
    ...
    public required init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(AddShareLinkToWebLinkRequestBodySharedLinkAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(AddShareLinkToWebLinkRequestBodySharedLinkPermissionsField.self, forKey: .permissions)
    }
