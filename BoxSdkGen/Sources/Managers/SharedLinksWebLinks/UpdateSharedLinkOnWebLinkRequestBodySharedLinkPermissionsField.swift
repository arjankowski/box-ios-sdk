...
public class UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsField: Codable {
    ...
    /// Initializer for a UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsField.
    ///
    /// - Parameters:
