...
public class SharedLinksWebLinksManager {
    ...
    public func findWebLinkForSharedLink(queryParams: FindWebLinkForSharedLinkQueryParams = FindWebLinkForSharedLinkQueryParams(), headers: FindWebLinkForSharedLinkHeaders) async throws -> WebLink {
        ...
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/shared_items#web_links")", method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
    ...
    public func getSharedLinkForWebLink(webLinkId: String, queryParams: GetSharedLinkForWebLinkQueryParams, headers: GetSharedLinkForWebLinkHeaders = GetSharedLinkForWebLinkHeaders()) async throws -> WebLink {
        ...
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/web_links/")\(webLinkId)\("#get_shared_link")", method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
        return try WebLink.deserialize(from: response.data!)
    }
    ...
    public func addShareLinkToWebLink(webLinkId: String, requestBody: AddShareLinkToWebLinkRequestBody = AddShareLinkToWebLinkRequestBody(), queryParams: AddShareLinkToWebLinkQueryParams, headers: AddShareLinkToWebLinkHeaders = AddShareLinkToWebLinkHeaders()) async throws -> WebLink {
        let queryParamsMap: [String: String] = Utils.Dictionary.prepareParams(map: ["fields": Utils.Strings.toString(value: queryParams.fields)])
        let headersMap: [String: String] = Utils.Dictionary.prepareParams(map: Utils.Dictionary.merge([:], headers.extraHeaders))
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/web_links/")\(webLinkId)\("#add_shared_link")", method: "PUT", params: queryParamsMap, headers: headersMap, data: requestBody.serialize(), contentType: "application/json", responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
        return try WebLink.deserialize(from: response.data!)
    }
    ...
    public func updateSharedLinkOnWebLink(webLinkId: String, requestBody: UpdateSharedLinkOnWebLinkRequestBody = UpdateSharedLinkOnWebLinkRequestBody(), queryParams: UpdateSharedLinkOnWebLinkQueryParams, headers: UpdateSharedLinkOnWebLinkHeaders = UpdateSharedLinkOnWebLinkHeaders()) async throws -> WebLink {
        let queryParamsMap: [String: String] = Utils.Dictionary.prepareParams(map: ["fields": Utils.Strings.toString(value: queryParams.fields)])
        let headersMap: [String: String] = Utils.Dictionary.prepareParams(map: Utils.Dictionary.merge([:], headers.extraHeaders))
        let response: FetchResponse = try await networkSession.networkClient.fetch(options: FetchOptions(url: "\(networkSession.baseUrls.baseUrl)\("/2.0/web_links/")\(webLinkId)\("#update_shared_link")", method: "PUT", params: queryParamsMap, headers: headersMap, data: requestBody.serialize(), contentType: "application/json", responseFormat: ResponseFormat.json, auth: auth, networkSession: networkSession))
        return try WebLink.deserialize(from: response.data!)
    }
