...
public class AddShareLinkToFolderRequestBodySharedLinkPermissionsField: Codable {
    ...
    /// Initializer for a AddShareLinkToFolderRequestBodySharedLinkPermissionsField.
    ///
    /// - Parameters:
