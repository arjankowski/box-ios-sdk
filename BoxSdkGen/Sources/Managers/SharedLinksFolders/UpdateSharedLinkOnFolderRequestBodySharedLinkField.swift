...
public class UpdateSharedLinkOnFolderRequestBodySharedLinkField: Codable {
    ...
    /// accounts.
    public let access: UpdateSharedLinkOnFolderRequestBodySharedLinkAccessField?
    ...
    /// Initializer for a UpdateSharedLinkOnFolderRequestBodySharedLinkField.
    ///
    /// - Parameters:
