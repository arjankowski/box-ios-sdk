...
public class SkillInvocationTokenReadField: Codable {
    ...
    public let tokenType: SkillInvocationTokenReadTokenTypeField?
    ...
    /// Initializer for a SkillInvocationTokenReadField.
    ///
    /// - Parameters:
    ...
    ///     providing a list of resources (files, folders, etc)
    ///     and the scopes permitted for each of those resources.
    public init(accessToken: String? = nil, expiresIn: Int64? = nil, tokenType: SkillInvocationTokenReadTokenTypeField? = nil, restrictedTo: String? = nil) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        tokenType = try container.decodeIfPresent(SkillInvocationTokenReadTokenTypeField.self, forKey: .tokenType)
