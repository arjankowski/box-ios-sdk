...
public class AiStudioAgentBasicTextTool: AiAgentBasicTextTool {
    ...
    public init(model: String? = nil, numTokensForCompletion: Int64? = nil, llmEndpointParams: AiLlmEndpointParamsAwsOrAiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi? = nil, systemMessage: String? = nil, promptTemplate: String? = nil, isCustomInstructionsIncluded: Bool? = nil) {
