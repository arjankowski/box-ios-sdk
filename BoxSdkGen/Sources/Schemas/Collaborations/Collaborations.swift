...
public class Collaborations: Codable {
    ...
    /// Initializer for a Collaborations.
    ///
    /// - Parameters:
    ...
    public init(limit: Int64? = nil, nextMarker: TriStateField<String> = nil, prevMarker: TriStateField<String> = nil, entries: [Collaboration]? = nil) {
        self.limit = limit
