...
public class StoragePolicyAssignments: Codable {
    ...
    /// Initializer for a StoragePolicyAssignments.
    ///
    /// - Parameters:
    ...
    public required init(from decoder: Decoder) throws {
        ...
        entries = try container.decodeIfPresent([StoragePolicyAssignment].self, forKey: .entries)
    }
