...
public class DocGenTemplatesV2025R0: Codable {
    ...
    /// A list of templates.
    public let entries: [DocGenTemplateV2025R0]?

    /// Initializer for a DocGenTemplatesV2025R0.
    ///
    /// - Parameters:
    ...
    public init(limit: Int64? = nil, nextMarker: TriStateField<String> = nil, prevMarker: TriStateField<String> = nil, entries: [DocGenTemplateV2025R0]? = nil) {
        self.limit = limit
    ...
    public required init(from decoder: Decoder) throws {
        ...
        entries = try container.decodeIfPresent([DocGenTemplateV2025R0].self, forKey: .entries)
    }
