...
public class DocGenJobsV2025R0: Codable {
    ...
    /// List of jobs.
    public let entries: [DocGenJobV2025R0]?

    /// Initializer for a DocGenJobsV2025R0.
    ///
    /// - Parameters:
    ...
    public init(limit: Int64? = nil, nextMarker: TriStateField<String> = nil, prevMarker: TriStateField<String> = nil, entries: [DocGenJobV2025R0]? = nil) {
        self.limit = limit
    ...
    public required init(from decoder: Decoder) throws {
        ...
        entries = try container.decodeIfPresent([DocGenJobV2025R0].self, forKey: .entries)
    }
