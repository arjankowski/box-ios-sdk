...
public class DocGenTagsV2025R0: Codable {
    ...
    /// List of tags.
    public let entries: [DocGenTagV2025R0]?

    /// Initializer for a DocGenTagsV2025R0.
    ///
    /// - Parameters:
    ...
    public required init(from decoder: Decoder) throws {
        ...
        entries = try container.decodeIfPresent([DocGenTagV2025R0].self, forKey: .entries)
    }
