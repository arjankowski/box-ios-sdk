...
public class FileSharedLinkField: Codable {
    ...
    ///     These permissions refer to the shared link only and
    ///     do not supersede permissions applied to the item itself.
    public init(url: String, effectiveAccess: FileSharedLinkEffectiveAccessField, effectivePermission: FileSharedLinkEffectivePermissionField, isPasswordEnabled: Bool, downloadCount: Int64, previewCount: Int64, downloadUrl: TriStateField<String> = nil, vanityUrl: TriStateField<String> = nil, vanityName: TriStateField<String> = nil, access: FileSharedLinkAccessField? = nil, unsharedAt: TriStateField<Date> = nil, permissions: FileSharedLinkPermissionsField? = nil) {
        self.url = url
