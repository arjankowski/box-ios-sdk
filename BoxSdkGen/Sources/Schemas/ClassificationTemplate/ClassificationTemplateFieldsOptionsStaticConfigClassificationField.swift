...
public class ClassificationTemplateFieldsOptionsStaticConfigClassificationField: Codable {
    ...
    /// Initializer for a ClassificationTemplateFieldsOptionsStaticConfigClassificationField.
    ///
    /// - Parameters:
